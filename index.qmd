...
Therefore, the task at hand is to isolate the random component treatment variation that arises because of the cutoff rule. 

Following the recentering procedure, proposed by Borusyak \& Hull (2023), I summarize the non-random variation by computing an expected treatment across networks that might as well have been built.
:::
...
:::: {.cr-section layout="overlay-right"}
To get the expected treatment, I simulate the four counterfactual networks that could have been built, given the possible connection status of the two coin-flip red hubs.  [@cr-counterfactuals]
...
You can reach me at charoo_anand [at] berkeley.edu.
